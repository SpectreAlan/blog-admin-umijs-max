...
import AddOrEdit from "@/pages/Tag/addOrEdit";
import {ExclamationCircleFilled, PlusOutlined} from '@ant-design/icons';

const TagPage: React.FC = () => {
    const access = useAccess();
    const actionRef = useRef<ActionType>();
    const [selectedRows, setSelectedRows] = useState<Tag.TagItem[]>([]);
    ...
    const handleEdit = (record: Tag.TagItem) => {
        setId(record.id)
    ...
    const renderActions = (text: string, record: Tag.TagItem) => (
